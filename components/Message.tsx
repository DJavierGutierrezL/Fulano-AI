...
// ... (El código de las clases CSS sigue igual) ...
    ...
    return (
        <div className={wrapperClasses}>
            ...
            <div className={messageClasses}>
                {/* Lógica condicional: muestra la imagen si existe, si no, el texto */}
                {message.imageUrl ? (
                    <img src={message.imageUrl} alt="Generated by AI" className="rounded-lg" />
                ) : (
